...
<body>
    ...
    <nav class="blog-nav layui-header">
        <div class="blog-container">
            ...
            <!-- 杂谈 -->
            <a class="blog-logo" href="home.html">杂谈</a>
            <!-- 导航菜单 -->
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="/home/images/Logo_100.png" alt="杂谈" />
                                </div>
                                <p class="aboutinfo-nickname">杂谈</p>
                                <p class="aboutinfo-introduce">一个.NET程序员的个人博客，记录博主学习和成长之路，分享.NET方面技术和源码</p>
                                <p class="aboutinfo-location"><i class="fa fa-link"></i>&nbsp;&nbsp;<a target="_blank" href="#">www.lyblogs.cn</a></p>
                                <hr />
                                ...
                                <fieldset class="layui-elem-field layui-field-title">
                                    ...
                                    <div class="layui-field-box aboutinfo-abstract">
                                        <p style="text-align:center;">杂谈是一个由ASP.NET MVC开发的个人博客网站，诞生于2016年11月7日，起劲为止经历了一次大改，暂且称为杂谈2.0。</p>
                                        <h1>第一个版本</h1>
                            ...
                            <div class="aboutinfo">
                                ...
                                <fieldset class="layui-elem-field layui-field-title">
                                    ...
                                    <div class="layui-field-box aboutinfo-abstract abstract-bloger">
                                        <p style="text-align:center;">Absolutely，杂谈创始人，诞生于1996年2月14日，目前是一个码农，从事.NET开发。</p>
                                        <h1>个人信息</h1>
                                        <p>暂无</p>
                                        <h1>个人介绍</h1>
                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                ...
                                <p class="aboutinfo-introduce">Name：杂谈&nbsp;&nbsp;&nbsp;&nbsp;Site：www.lyblogs.cn</p>
                                            ...
                                            <ul class="blog-comment">
                                                <li>
                                                    <div class="comment-parent">
                                                        <img src="/home/images/Logo_40.png" alt="杂谈" />
                                                        <div class="info">
                                                            <span class="username">杂谈</span>
                                                        </div>
                                                        <div class="content">
                                                            我为大家做了模拟留言与回复！试试吧！
                                                        </div>
    ...
    <footer class="blog-footer">
        <p><span>Copyright</span><span>&copy;</span><span>2017</span><a href="#">杂谈</a><span>Design By LY</span></p>
