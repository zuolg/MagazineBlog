...
<head>
    <meta charset="utf-8" />
    <title>后台管理系统</title>
    <link rel="shortcut icon" href="/admin/images/Logo_40.png" type="image/x-icon">
    <!-- layui.css -->
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            <div class="ht-console">
                <div class="ht-user">
                    <img src="/admin/images/Logo_40.png" />
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="/admin/goUrl?path=content/content-list" data-id="1">文章管理</a></dd>
                            <dd><a href="javascript:;" data-url="/admin/goUrl?path=content/content-edit" data-id="2">资源管理</a></dd>
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <p style="padding: 10px 15px; margin-bottom: 20px; margin-top: 10px; border:1px solid #ddd;display:inline-block;">
                            ...
                            <span style="padding-left:1em;">地点：成都</span>
