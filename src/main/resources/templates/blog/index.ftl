...
<div class="main index_main">
	<a class="logo" href="./index.html"><img src="./images/logo.png" alt="博客前台模版"></a>
...
<div class="banner">
<div class="main index_main"> 
	<img class="banner_pic" src="./images/banner.jpg" alt="banner_学无止境">
</div>
</div>
<!-- banner 结束 -->
<div class="main index_main">
...
<div class="main index_main">
	...
	<ul class="page_left_list"> 
		<li>
			<a href="./article_view.html" class="pic"><img src="./images/article_pic.png" alt="博客上线了！"></a>
			<h2 class="title"><a href="./article_view.html">博客上线了！</a></h2>
			<div class="date_hits">
				<span></span>
				<span>2个月前</span>
				<span><a href="http://www.phplaozhang.com">博客</a></span>
	...
	<div class="page_right">
		...
		<div class="new_list">
			<h3>最新文章</h3>
			<ol class="page_right_list trans_3">
				<li><a href="http://www.phplaozhang.com">博客上线啦(二)</a><span class="hits"> 888 ℃ </span></li>
				<li><a href="http://www.phplaozhang.com">博客上线啦(二)</a><span class="hits"> 5 ℃ </span></li>
				<li><a href="http://www.phplaozhang.com">博客上线啦(二)</a><span class="hits"> 320 ℃ </span></li>
				<li><a href="http://www.phplaozhang.com">博客上线啦(二)</a><span class="hits"> 135 ℃ </span></li>
			</ol>
		</div>
		<div class="hot_list">
			<h3>最近热文</h3>
		...
		<div class="links trans_3">
			<a href="http://www.phplaozhang.com" target="_blank">博客</a>
		</div>
	</div>
	<div class="clear"></div>
</div>
...
<div class="layui-footer footer">
  <div class="main index_main">
    <p><a href="http://www.phplaozhang.com">博客</a> © phplaozhang.com</p>
    <p>
      <a href="">网站地图</a>
    </p>
    <p class="beian">
